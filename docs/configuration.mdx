...
**Required:** No  
**Default:** `project.layout.projectDirectory.dir("run")`
...
**Type:** `Action<PluginDownloadSpec>`
**Required:** No
...
**Type:** `ListProperty<String>`  
**Required:** No  
**Default:** `listOf("-Xmx2G")`

Arguments to pass to the Java virtual machine when starting the test server.
